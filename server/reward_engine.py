...
def evaluate_action(
    ...
    # 3. Personality Preservation (0.0 to 1.0)
    ...
    # 5. Relationship Impact (-0.5 to 0.5)
    ...
    # 6. Long-Term Thinking (0.0 to 0.5)
